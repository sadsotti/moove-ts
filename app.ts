// Moove System Interfaces
interface IVehicle {
    type: 'bike' | 'scooter' | 'kickscooter';
    id: string;
...
interface ICity {
    ...
    showVehicleStatus(): void; // Added for clarity
}
...
class Vehicle implements IVehicle {
    ...
    constructor(type: 'bike' | 'scooter' | 'kickscooter', id: string) {
        this.type = type;
        this.id = id;
